...
% Convertir cada elemento de VariableNames a string
...
longitud= min(length(VariableNames_WithoutDER), length(VariableNames));
posDER = -1;
for i = 1:longitud
    if ~strcmp(VariableNames_WithoutDER{i}, VariableNames{i})
        posDER = i;
        break;
    end
end
clear i;
clear longitud;
clear VariableNames_WithoutDER;
clear VariableNames;
...
if posDER == -1
    ...
    inicios1 = 2 : 3 : posDER-1;
    finales1 = 4 : 3 : posDER-1;
    inicios2 = posDER+3 : 3 : 222;
    finales2 = posDER+5 : 3 : 223;
    inicios = [inicios1 , inicios2];
    finales = [finales1 , finales2];
...
% ----- DER -----
I11 = transients(: , posDER:posDER+2);
I11 = normal( t , I11 , t2);
